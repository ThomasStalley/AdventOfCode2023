...
with open("AdventOfCode2023/InputData/input_01.txt", "r") as file:
    calibrations = [row.strip() for row in file.readlines()]
...
def part_one(input_list):
    ...
    for calibration in input_list:
        ...
        partial_calibration = digits_only_string[0] + digits_only_string[-1]
        total_calibration_p1 += int(partial_calibration)
...
print("-> Part One:", part_one(calibrations))
print("-> Part Two:", part_two(calibrations))
